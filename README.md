...
* The upload of PNGs and JPEGs are limited in their dimensions (to prevent imagemagick memory issues). To increase the
  limits, add the following constants to your `wp-config.php`:
  ```php
