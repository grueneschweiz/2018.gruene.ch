...
$wrap_attrs['class'] .= ' a-checkoption';
$input_attrs['class'] .= ' a-checkoption__field';
$label_attrs['class'] .= ' a-checkoption__label';

if ($label_required) {
	$label_attrs['class'] .= ' a-input__label--required';
}

include WP_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'torro-forms' . DIRECTORY_SEPARATOR . 'templates' . DIRECTORY_SEPARATOR . 'element-checkbox.php';
