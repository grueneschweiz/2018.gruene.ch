...
/**
 * This is just a copy of the build in WP_List_Table class, loaded under
 * out custom namespace to prevent conflicts. To make a copy of the class is
 * suggested in the wordpress docs.
 *
