				...
				'sub_fields'        => array(
					...
					array(
						...
						'choices'           => array(
							...
							'landlinePhone'             => 'Telefon / tél. priv.',
							'workPhone'                 => 'Telefon / tél. prof.',
							...
							'newsletterOther'           => 'Anderer Newsletter / autre infolettre',
							...
							'membershipEnd'             => 'Ende Mitgliedschaft / date de sortie',
							'responsibility'            => 'Zuständigkeit / compétence',
							'membershipFeeCountry'      => 'MB National / cotisation nationale',
							'membershipFeeCanton'       => 'MB Kantonal / cotisation cantonale',
							'membershipFeeRegion'       => 'MB Bezirk / cotisation du district',
							'membershipFeeMunicipality' => 'MB Kommunal / cotisation communale',
							'membershipFeeYoung'        => 'MB Junge Grüne / cotisation Jeunes Verts',
							'interests'                 => 'Interessen / intérêts',
							'request'                   => 'Anfragen für / disponibilités',
							'profession'                => 'Beruf / profession',
							'donorCountry'              => 'Spendenstatus National / statut de donatrice nationale',
							'donorCanton'               => 'Spendenstatus Kantonal / statut de donatrice cantonale',
							'donorRegion'               => 'Spendenstatus Bezirk / statut de donatrice du district',
							'donorMunicipality'         => 'Spendenstatus Kommunal / statut de donatrice communale',
							'donorYoung'                => 'Spendenstatus Junge Grüne / statut de donatrice Jeunes Verts',
							'roleCountry'               => 'Funktion National / fonctions nationales',
							'roleCanton'                => 'Funktion Kantonal / fonctions cantonales',
							'roleRegion'                => 'Funktion Bezirk / fonctions dans le district',
							'roleMunicipality'          => 'Funktion Kommunal / fonctions communales',
							'roleInternational'         => 'Funktion International / fonctions internationales',
							'roleYoung'                 => 'Funktion Junge Grüne / fonctions chez les Jeunes Verts',
							...
							'notesCantonYoung'          => 'Notizen kantonal JG / notes cantonales JV',
							'notesCountryYoung'         => 'Notizen national JG / notes nationales JV',
						),
						'default_value'     => array(),
						'allow_null'        => 1,
						'multiple'          => 0,
...
Example interest field: Only the interests that can be selected in Webling are accepted values.', THEME_DOMAIN ),
			...
			...(defined('MAILCHIMP_SERVICE_ENDPOINT') ? [
				array(
					'key'               => 'field_59f33e699d496',
					'label'             => __( 'Force CRM Sync', THEME_DOMAIN ),
					'name'              => 'force_crm_sync',
					'type'              => 'true_false',
					'instructions'      => __( 'When enabled, form submissions will only sync to CRM and skip direct Mailchimp sync.', THEME_DOMAIN ),
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '100',
