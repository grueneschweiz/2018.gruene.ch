	...
	acf_add_local_field_group( array(
		...
		'fields'                => array(
			...
			array(
				...
				'sub_fields'        => array(
					array(
						...
						'type'              => 'email',
						'instructions'      => __( 'This email address will receive notifications when a form is completed.',
							THEME_DOMAIN ),
						'required'          => 1,
						'conditional_logic' => 0,
						'wrapper'           => array(
			...
			array(
				...
				'type'              => 'text',
				'instructions'      => __( 'This is the name that will appear as the sender (the e-mail will always be website@yourdomain.tld).',
					THEME_DOMAIN ),
				'required'          => 1,
				'conditional_logic' => 0,
				'wrapper'           => array(
